    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (caption.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Post must have a caption", Toast.LENGTH_SHORT).show();
                    return;
                }

                else if (photoFile == null || ivPostImage.getDrawable() == null) {
                    Toast.makeText(MainActivity.this, "Post must have a photo", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void savePost(String caption, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                Log.i(TAG, "Saving post is successful");
                etCaption.setText("");
